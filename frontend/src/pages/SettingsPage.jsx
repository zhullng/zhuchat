    ...
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-1 mt-6">
          ...
          <p className="text-sm text-base-content/70">Choose a language for your chat interface</p>
        </div>
        <div className="space-x-4 mt-3">
          <button
            onClick={() => setLanguage("en")}
            className={`btn ${language === "en" ? "bg-primary text-primary-content" : "bg-base-300"}`}
          >
            English
          </button>
          <button
            onClick={() => setLanguage("pt")}
            className={`btn ${language === "pt" ? "bg-primary text-primary-content" : "bg-base-300"}`}
          >
            Português
          </button>
        </div>
